...
typedef struct {
  ...
  real_T Minus[2];                     /* '<Root>/Minus' */
  real_T Add;                          /* '<Root>/Add' */
  real_T Sum3_h;                       /* '<S5>/Sum3' */
  real_T Sum1;                         /* '<S3>/Sum1' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } adjusttravel_PWORK;                /* '<Root>/adjust travel' */
  ...
  struct {
    void *LoggedData;
  } elevationcheck_PWORK;              /* '<Root>/elevationcheck' */
...
struct P_helicopter_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T pitch_ref_Value;              /* Expression: 0.1
